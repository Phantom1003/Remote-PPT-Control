...
class PPTControler:
	...
	def moveMouse(self, x, y):
		...
		win32api.SetCursorPos((ox+6*x, oy+6*y))
		# win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN, ox, oy, 0, 0)
		# win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP, ox+x, oy+y, 0, 0)
		return 0
	...
	def touchEnd(self):
		(ox, oy) = win32api.GetCursorPos()
		win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP, ox, oy, 0, 0)
